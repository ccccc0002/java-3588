layui.define(['table', 'laypage','jquery', 'element'], function(exports) {
	...
	var card_report = function(opt) {
		_instances[opt.elem.substring(1)] = this;
		this.reload(opt);
	};
	card_report.prototype.initOptions = function (opt) {
	...
	card_report.prototype.init = function () {
	...
	card_report.prototype.reload = function (opt) {
	...
	var tt = {
		...
		render: function (options) {
			return new card_report(options);
		},
